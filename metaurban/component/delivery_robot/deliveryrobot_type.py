...
class EgoVehicle(EgoDeliveryRobot):
    ...
    TIRE_TWO_SIDED = True
    FRONT_WHEELBASE = 0.3#0.3#0.5#0.3#0.5#0.25#1.385
    REAR_WHEELBASE = 0.3#0.3#0.5#0.3#0.5#0.25#1.11
    TIRE_RADIUS = 0.2#0.1#0.2#0.05#0.15#0.1#0.376
    TIRE_WIDTH = 0.2#0.1#0.2#0.05#0.1#0.1#0.25
    MASS = 500
